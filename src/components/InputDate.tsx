    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="relative flex items-center">
        <CalendarIcon
          ...
          className={cls("absolute left-3 size-[20px] cursor-pointer", value ? "text-black03" : "text-gray02")}
        />

        <DatePicker
          ref={datePickerRef}
          className={cls(
            "flex h-[50px] w-[500px] items-center rounded-lg border border-solid border-gray03 pl-10 text-base placeholder-gray02 md:text-lg",
          ...
          customInput={
            <div onClick={handleDatePickerOpen} className="cursor-pointer">
