  ...
  return (
    ...
    >
      ...
      <div className="relative flex h-[700px] w-full shrink-0 flex-col">
        ...
        <button type="button" onClick={onClickSidebar} className={cls("flex h-10 w-full items-center justify-start")}>
          <HiChevronDoubleRight className={cls("text-gray01", isExpanded ? "hidden" : "")} />
          <HiChevronDoubleLeft className={cls("text-gray01", isExpanded ? "" : "hidden")} />
        </button>
